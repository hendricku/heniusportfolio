  ...
  return (
    <div className="flex flex-col lg:flex-row relative z-10">
      ...
      <motion.aside
        ...
        style={{ maxHeight: '100vh' }} // Ensures sidebar doesn't exceed viewport height
      >
      ...
      <main className="w-full lg:ml-[300px] p-4 md:p-8 lg:p-12 xl:p-16 2xl:p-24">
        ...
        <section className="max-w-7xl mx-auto mt-20">
          ...
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">Education History</h2>
